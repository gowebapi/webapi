...
func OnErrorEventHandlerToJS(callback OnErrorEventHandler) *js.Callback {
	if callback == nil {
		return nil
	}
...
func OnBeforeUnloadEventHandlerToJS(callback OnBeforeUnloadEventHandler) *js.Callback {
	if callback == nil {
		return nil
	}
	ret := js.NewCallback(func(args []js.Value) {
