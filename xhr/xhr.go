...
func (_this *FormData) Append2(name string, blobValue *fileapi.Blob, filename *string) {
	var (
		_args [3]interface{}
		_end  int
	)
...
func (_this *FormData) Set2(name string, blobValue *fileapi.Blob, filename *string) {
	var (
		_args [3]interface{}
		_end  int
	)
